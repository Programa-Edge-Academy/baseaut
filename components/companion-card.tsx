...
export function CompanionCard({ className }: { className?: string }) {
  return (
    <View className={`w-full max-w-[380px] rounded-[20px] bg-[#181C25] p-5 shadow-lg ${className ?? ""}`}>
      {/* Header Fixo */}
      <View className="mb-5 flex-row items-center gap-3">
        <GraduationCap size={24} color="#1DB954" />
      ...
      <View className="h-[1px] bg-[#2B303B] my-2 w-full opacity-50" />
