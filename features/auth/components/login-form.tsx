...
/**
 * Maps Supabase auth errors to localized UI-friendly messages.
 */
...
/**
 * Login form UI with validation and submit handling.
 */
      ...
      <View className="w-full max-w-[342px] gap-4">
        <View className="w-full gap-1">
          ...
          <DefaultTextInput
            ...
            outLineBorderClass={
              localErrors.email ? "border-error" : "border-outline"
            }
            value={email}
            onChangeText={(text) => {
              setEmail(text);
